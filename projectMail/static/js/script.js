...
function init() {
	...
	cylinderMaterial.map = textureLoader.load('./static/assets/textures/concrete.jpg');
	cylinderMaterial.bumpMap = textureLoader.load('./static/assets/textures/concrete.jpg');
	...
	wallMaterial.bumpMap = textureLoader.load('./static/assets/textures/concrete.jpg');
	wallMaterial.roughnessMap = textureLoader.load('./static/assets/textures/concrete.jpg');
	...
	// planeMaterial.bumpMap = textureLoader.load('./static/assets/textures/concrete.jpg');
	// planeMaterial.roughnessMap = textureLoader.load('./static/assets/textures/concrete.jpg');
